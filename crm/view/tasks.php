...
<div class="container">
    ...
    <div class="adverts">
        ...
        ?>
                ...
                ?>
                    <div class="advert">
                        ...
                        <form action="<?php echo middleware('task', 'readiness') . '?id=' . $task['id'] ?>" method="post">
        ...
        ?>
        <h3><a href="<?php echo view('tasksHistory') ?>">История задач</a></h3>
    </div>
</div>